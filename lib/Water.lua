...
function Water.begin(ctx)
  ...
  -- Always bind the sampler, including the unavailable-canvas fallback.
  send("castTex", ctx.cast or ctx.reflect)
  send("castOn", ctx.cast and Water.CAST_ALPHA > 0 and 1 or 0)
