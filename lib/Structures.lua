  ...
  for cy = math.floor(y0 / 2), math.floor(y1 / 2) do
    for cx = math.floor(x0 / 2), math.floor(x1 / 2) do
      ...
      local near = cx * 2 >= -ROUND_RING and cx * 2 < tw + ROUND_RING
               ...
               -- Authored forest connectors own a continuous rectangular
               -- wall. Rounding their 2x2 courses punches holes in the edge
               -- and makes its shape depend on which adjacent map is root.
